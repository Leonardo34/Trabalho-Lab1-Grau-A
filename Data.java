...
public class Data
{
   ...
   public int diasDeOutraData(Data outra)
   {
    ...
    /** metodo que devolve a data de hoje - feito pela Vera - todavia
     * nao acho legal colocar aqui, pois ele deve ser acionado por outro objeto data
     * seria um comportamento de um outro objeto Data - sob o ponto de vista de modelagem
     * nao esta legal.
     */
    public Data getDataDeHoje(){
       GregorianCalendar c = new GregorianCalendar();
       int d = c.get(GregorianCalendar.DAY_OF_MONTH);
       int m = c.get(GregorianCalendar.MONTH)+1;
       int a = c.get(GregorianCalendar.YEAR);
